...
from replays import collect as collect_replays
...
def cmd_replays(a):
    collect_replays(log_root=a.log_root, docs_dir=a.docs_dir, keep=a.keep)
...
def main():
    ...
    v = sub.add_parser("replays", help="collect replays and build the viewer page")
    v.add_argument("--log-root", default="logs")
    v.add_argument("--docs-dir", default="docs")
    v.add_argument("--keep", type=int, default=150)
    v.set_defaults(func=cmd_replays)
